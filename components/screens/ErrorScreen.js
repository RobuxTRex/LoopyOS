  ...
  return (
    <div className={styles.container}>
      <div className={styles.root}>
        ...
        <p className={styles.description}>The system will automatically restart in 30 seconds</p>

        <div>
          <h2 className={styles.errorTitle}>Error Information</h2>

          <ul className={styles.errorInfo}>
            <li><code>code: {error.code ?? "RUNTIME_ERROR"}</code></li>
            ...
            {error.data && error.code ? (
              ...
              <>
                <li><code>name: {error.name}</code></li>
